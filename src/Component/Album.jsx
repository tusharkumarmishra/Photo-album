...
export default function Album() {
    ...
    return (
      <>
            <header>
                <h1 className={`display-1 text-center py-5 ${style.albumH1}`}> <img src="https://i.pinimg.com/originals/67/a1/6a/67a16a4e1e6e63d74739be47dffbfe02.png" width={'100px'} alt="..." /> Album Collection </h1>
            </header>
            ...
            <footer className={style.albumFooter}>
                <p>All trademarks are properties of their respective owners. 2023-2023 © Album Collection by Tushar™ Ltd. All rights reserved.</p>
            </footer>
        </>
